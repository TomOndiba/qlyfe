...
<?php /* @qlyfe addition.. upgrade to jquery 1.4 and jquery-ui 1.8 and including dialogs
...
*/ ?>
	...
	<script type="text/javascript" src="<?php echo $vars['url']; ?>vendors/jquery/jquery-ui-1.8.2.custom.min.js"></script>
...
?>
	...
	<link rel="stylesheet" href="<?php echo $vars['url']; ?>vendors/jquery/jquery-ui-1.8.2.custom.css" type="text/css" />
