...
<div id="elgg_topbar_container_left">
	<div class="toolbarimages">
		<a href="/" target="_blank"><img src="<?php echo $vars['url']; ?>_graphics/qlyfe-logo.png" alt="toolbar_logo graphic" /></a>
	...
	<div class="toolbarlinks">
		...
		<?php //allow people to extend this top menu
...
<?php echo elgg_view('js/connect', $vars); ?>
