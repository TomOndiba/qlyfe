...
$(document).ready(function() {
	...
	$("#widgetform<?php echo $guid; ?>").submit(function () {
		...
		$.post($("#widgetform<?php echo $guid; ?>").attr("action"),variables,function() {
			...
			$("#widgetcontent<?php echo $guid; ?>").load("<?php echo $vars['url']; ?>pg/view/<?php echo $guid; ?>?shell=no&username=<?php echo page_owner_entity()->username; ?>&context=<?php echo get_context(); ?>&sub_context=<?php echo urlencode(get_sub_context()); ?>&callback=true");
		});
		return false;
