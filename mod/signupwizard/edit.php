<?php
	...
	// Get edit form
	$area2 = elgg_view_title(elgg_echo('profile:editprofile'));
	
	// call profile page 
	$area2 .= elgg_view("profile/edit",array('entity' => $user,"actionurl"=>"signupwizard")); 
	...
	// Draw the page
	page_draw(elgg_echo("profile:editprofile"),$body);
