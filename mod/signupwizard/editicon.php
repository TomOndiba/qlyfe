<?php
	...
	// set title
	$area2 = elgg_view_title(elgg_echo('signupwizard:editicon'));

	$area2 .= elgg_view("profile/editicon", array('entity' => $user,"actionurl"=>"signupwizard"));
	
	// Get the form and correct canvas area
	$body = elgg_view_layout("", '', $area2);
	
	// Draw the page
	page_draw(elgg_echo("signupwizard:editicon"), $body);
