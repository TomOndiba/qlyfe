...
?>
	    	<p class="user_menu_profile">
				<a href="javascript:showuser()"><?php echo elgg_echo("profile:aboutme"); ?></a>
			</p>
	    	<p class="user_menu_profile">
				<a href="<?php echo $vars['url']?>pg/profile/<?php echo $owner->username?>/editicon/"><?php echo elgg_echo("profile:editicon"); ?></a>
			</p>
<?php 	    	
...
?>
	    	<p class="user_menu_profile">
				<a href="javascript:showuser()"><?php echo elgg_echo("profile:about"); ?></a>
			</p>
<?php 	    	
	        echo elgg_view("profile/menu/actions",$vars); //grab action links such as make friend
