<?php
	...
	// Get entity
		...
		$href = $vars['href'];
		if (!$href) $href = $vars['entity']->getURL();
...
<div class="avatar_menu_button"><img src="<?php echo $vars['url']; ?>_graphics/spacer.gif" border="0" width="15px" height="15px" /></div>
	...
	**/?>
	<?php
	 ...
	 ?><a href="<?php echo $href ?>" class="icon" ><?php 
		}
...
//	if($network == "")
	...
	?><img src="<?php echo $vars['entity']->getIcon($vars['size'],$network); ?>" border="0" <?php echo $align; ?> alt="<?php echo htmlentities($vars['entity']->name, ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlentities($vars['entity']->name, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $vars['js']; ?> /> <?php echo $label?><?php
