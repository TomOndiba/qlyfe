<?php
	...
	$english = array(
		 ...
		 */
			...
			'messageboard:share' => "Share",
			'messageboard:comment' => "Comment",
			'messageboard:delete'=>"Delete",
			'messageboard:confirmdeletion'=>"Are you sure you wanted to delete this message ?",
         /**
