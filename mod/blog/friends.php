<?php
	...
	//set the title
		...
		// note: this does not pass offset because list_user_connection_objects gets it from input
		$area2 .= list_user_connection_objects($page_owner->getGUID(),'blog',10,false);
