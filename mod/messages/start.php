	 ...
	 */
	    ...
	    function messages_init() {
	        ...
	        // Extend hover-over and profile menu	
				...
				elgg_extend_view('account/links', 'messages/accountlinks', 400);
		    ...
		    // Shares widget
			  //  add_widget_type('messages',elgg$currentclass_echo("messages:recent"),elgg_echo("messages:widget:description"));
