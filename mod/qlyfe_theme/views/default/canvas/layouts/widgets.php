...
<table class="draggable_widget" cellspacing="0"><tr><td width="149px">
	<h3>
		...
		?>" />
		<input type="hidden" name="multiple" value="<?php echo $widgettypes[$widget->handler]->multiple; ?>" />
		<input type="hidden" name="side" value="<?php echo $widgettypes[$widget->handler]->positions && in_array('side',$widgettypes[$widget->handler]->positions); ?>" />
		<input type="hidden" name="main" value="<?php echo $widgettypes[$widget->handler]->positions && in_array('main',$widgettypes[$widget->handler]->positions); ?>" />
		<input type="hidden" name="description" value="<?php echo htmlentities($widgettypes[$widget->handler]->description, ENT_QUOTES, 'UTF-8'); ?>" />
		<input type="hidden" name="guid" value="<?php echo $widget->getGUID(); ?>" />
	</h3>
</td>
...
<tr>
	<td align="left" valign="top" id="widgets_left_td">
		<div  id="widgets_left">
	...
	<td align="left" valign="top"  id="widgets_middle_td">
	...
	<td align="left" valign="top" id="widgets_right_td">
